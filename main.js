...
const connectMetamask = async() => {
    ...
    element.innerHTML = "Metamask Bağlı " + WALLET_CONNECTED;
}fronend
...
const addVote = async() => {
    if(WALLET_CONNECTED != 0) {
        ...
        var cand = document.getElementById("cand");
        cand.innerHTML = "Lütfen Önce Metamask'ı Bağlayın";
    }
}
...
const voteStatus = async() => {
    if(WALLET_CONNECTED != 0) {
        ...
        console.log(time);
        status.innerHTML = currentStatus == 1 ? "Oylama Şuanlık Açık" : "Oylama Bitti";
        remainingTime.innerHTML = `Kalan Zaman ${parseInt(time, 16)} Saniye`;
    }
    else {
        var status = document.getElementById("status");
        status.innerHTML = "Lütfen Önce Metamask'ı Bağlayın";
    }
}
...
const getAllCandidates = async() => {
    if(WALLET_CONNECTED != 0) {
        ...
        p3.innerHTML = "Tablo Güncellendi"
    }
    else {
        var p3 = document.getElementById("p3");
